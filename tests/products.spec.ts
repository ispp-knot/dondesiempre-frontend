...
test.describe.serial('test products as a store', () => {
  ...
  test('create products', async ({ page }) => {
    ...
    await page.getByTestId('product-image-input').locator('input[type="file"]').setInputFiles('tests/scripts/foto-pantalon.jpg');
  ...
  test('Create variants of a product', async ({ page }) => {
    ...
    await expect(page.getByTestId('product-size').getByRole('button', { name: 'S' })).toBeVisible();
  ...
  test('deleting a variant', async ({ page }) => {
    ...
    await expect(page.locator('label').filter({ hasText: 'Talla: S · Color:' }).first()).toBeVisible();
  ...
  test('editing product', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'Descripción' }).fill('Segunda Descripción Actualizada');
    await page.getByTestId('product-edit-image-input').locator('input[type="file"]').setInputFiles('tests/scripts/foto-camiseta.jpg');
    ...
    test('deleting product', async ({ page }) => {
        ...
        await page.getByTestId('product-card').nth(2).click();
