...
import { LuPackage, LuCrown } from 'react-icons/lu';
...
export default function Navbar() {
  ...
  if (!mounted) {
    return (
      <div className="hidden sm:flex bg-white w-full h-17.5 items-center justify-center z-20 shadow-md">
        <div className="flex flex-row items-center w-11/12 justify-between">
          <div className="flex flex-row items-center gap-2">
            ...
            <span className="text-2xl font-bold text-primary">Donde </span><span className='text-secondary! text-2xl! font-bold!'>Siempre</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="hidden sm:flex bg-white text-primary w-full h-17.5 items-center justify-center z-20 shadow-md">
