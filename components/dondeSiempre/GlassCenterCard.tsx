...
export function GlassCenterCard({
  ...
  return (
    <main className="relative flex flex-1 flex-col items-center justify-center px-4 sm:px-8 sm:py-8 sm:bg-primary/10">
      ...
      <Card className="relative z-10 w-full py-6 sm:max-w-md sm:p-8 sm:rounded-2xl sm:border sm:border-white/40 sm:bg-white/85 sm:shadow-xl sm:backdrop-blur-md">
        {logo && (
